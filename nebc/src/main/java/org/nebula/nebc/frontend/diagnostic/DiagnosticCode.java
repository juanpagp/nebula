...
{
	// --- General & Entry Point ---
	MISSING_MAIN_METHOD("No 'main' entry point found."), DUPLICATE_MAIN_METHOD("Duplicate 'main' method. Entry point already defined."), INVALID_MAIN_SIGNATURE("'main' must return 'i32' or 'void', and have no parameters."),
